...
public class ConfigurationServiceClientRefitTests : ConfigurationServiceClientTestsBase
{
    public ConfigurationServiceClientRefitTests() : base(0) { }
    ...
    public async Task IntegrationTestRefit()
    {
